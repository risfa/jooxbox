...
<script type="text/javascript">
    ...
    // $(document).getElementById("tombol_tambah_playlist").click(function(){
    // 	alert("BABA");
  ...
  <body style="background-color:#fff;background-size:cover;margin-bottom:140px">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	...
	      	<center>Select your playlist [STILL ON PROGRESS...]<br><br>
	      	<select class="form-control"  id = "list-name">
	      		<?php 
	      		...
	      		<option value="<?php echo $getPlaylist[$i]->playlist_name  ?>" > <?php echo $getPlaylist[$i]->user_id; ?></option>
	      		<?php } ?>
	      			<?php }else{?>
	      				<option><?php echo "Tidak ada playlist "?></option>
	      					<?php } ?>


	      			
	      	</select><br>
	      	<button class="btn btn-success" onclick="simpan_playlist()">SAVE</button>
	      	</center>
	      </div>
	...
	<?php 
					...
					// echo json_encode($getPlaylist);
        				//echo $getPlaylist[0]->playlist_name;
