                        ...
                        if(json.status){
                            ...
                            $.each(json.data,function (k,v) {
                               ...
                               getPlaylistDetail(v.playlist_id,"tbl-playlist-"+v.playlist_id);
                                row+='</table>'+
                                    '<button class="btn btn-primary add-playlistItem" data-plid="'+v.playlist_id+'" data-plname="'+v.playlist_name+'"><i class="fa fa-plus"></i> Tambah Lagu</button> '+
                                    '<button class="btn btn-danger del-playlist" data-plid="'+v.playlist_id+'"><i class="fa fa-trash"></i> Delete Playlist</button> '+
                                    '<button class="btn btn-info edit-playlist" data-plid="'+v.playlist_id+'" data-plname="'+v.playlist_name+'"><i class="fa fa-trash"></i> Edit Playlist Name</button>'+
                                    '</div>'+
                                    '</div>';
                                html+=row;
                                playlist_number++;
                        ...
                        if(json.status){
                            $.each(json.data,function (k,v) {
                                html += '<tr class="row-song-playlist-user">' +
                                    '<td style="vertical-align: middle" align="center"><i class="fa fa-youtube-play" style="color:#bb0000"></i></td>' +
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo site_url(); ?>"><div>&#8592; BACK TO HOME2</div></a></li>                        
      			<li class="dropdown">
    ...
    <div class="container" height="100%">
		...
		<div class="col-sm-5" style="padding-top:20px;">
			<div class="col-xs-12 header-menu-jukebox" style="text-align:left">
				<i class="fa fa-music"></i> &nbsp;&nbsp;<?php echo $this->config->item("user_playlist") ?>
			</div>
			<br/><br/>
			<br/>
			...
			<button class="btn btn-default" data-toggle="modal" data-target="#modalPlaylist"><i class="fa fa-list"></i> Add Playlist</button>
			...
			<div id="modalEditPlaylist" class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
			  <div class="modal-dialog modal-sm" role="document">
			    <div class="modal-content">
			      ...
			      <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			        <h4 class="modal-title" id="myModalLabel">Edit Playlist Name</h4>
			      </div>
			      <div class="modal-body">
			        <form>
			        	<div class="form-group">
					    	<label for="playlistName">Edit Playlist Name</label>
