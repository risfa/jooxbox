...
<body class="stretched">
				...
				<div class="container clearfix">
					...
					<nav id="primary-menu" class="style-3">
                        ...
                        <ul>
                            ...
                            <li class="current" style="margin-right:20px" ><a href="https://jukebox5d.com/app/index.php/login"><div><i class="fa fa-music"></i> Mainkan Sekarang</div></a></li>							
                        </ul>
    ...
    <script id="domain" data-name="8338340" type="text/javascript" src="http://xeniel.5dapps.com/webanalytic/js/analytics_js/client.js"></script>
</body>
</html>